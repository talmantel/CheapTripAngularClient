...
PathDetailsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: PathDetailsComponent, selectors: [["app-path-details"]], inputs: { paths: "paths", startPoint: "startPoint", endPoint: "endPoint" }, decls: 1, vars: 1, consts: function () { let i18n_0; if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        ...
        i18n_2 = " duration includes transfer to/from airport ";
...
class ErrorInterceptor {
        ...
        return next.handle(req).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["tap"])((evt) => {
            ...
            switch (true) {
                ...
                case error.status >= 500:
                    ...
                    break;
                default:
                    errorData = new _error_alertMessage_model__WEBPACK_IMPORTED_MODULE_8__["AlertMessage"]('error', error.name, 'Unknown error', [new _error_alertMessage_model__WEBPACK_IMPORTED_MODULE_8__["Button"]("Close", "Close")]);
                    break;
            }
    ...
    showError(title, message) {
        const alertMessage = new _error_alertMessage_model__WEBPACK_IMPORTED_MODULE_8__["AlertMessage"]('error', title, message, [new _error_alertMessage_model__WEBPACK_IMPORTED_MODULE_8__["Button"]("Close", "Close")]);
